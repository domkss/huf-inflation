      ...
      <div className='container mx-auto px-6'>
        <div className='flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0'>
          <div className='text-sm text-center md:text-left'>
            <p>
              Az oldalon található adatok kizárólag tájékoztató jellegűek. Az oldal üzemeltetője mindent megtesz a
              pontosság érdekében, de nem vállal felelősséget az esetleges hibákért vagy elavult információkért.
            </p>
            <p className='mt-2'>
